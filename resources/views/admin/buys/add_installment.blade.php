        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4>Add Installment Payment for Buy #{{ $buy->id }}</h4>
                    <a href="{{ route('buys.index') }}" class="btn btn-secondary">Back to Buys</a>
                </div>

                <div class="card-body">
                    <div class="mb-3">
                        <strong>Supplier:</strong> {{ $buy->supplier->name ?? 'N/A' }}<br>
                        <strong>Total Amount:</strong> {{ number_format($buy->total_amount, 2) }}<br>
                        <strong>Paid Amount:</strong> {{ number_format($buy->paid_amount, 2) }}<br>
                        <strong>Due Amount:</strong> {{ number_format($buy->due_amount, 2) }}
                    </div>
                    ...
                    <form action="{{ route('buys.store_installment', $buy) }}" method="POST">
                        @csrf
                            ...
                            <div class="payment-item mb-3 border p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" name="payment_items[0][amount]" id="amount_0" class="form-control" step="0.01" min="0" max="{{ $buy->due_amount }}" required>
                                    </div>
                                    <div class="col-md-3">
            ...
            <div class="payment-item mb-3 border p-3">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="payment_items[${itemCount}][amount]" id="amount_${itemCount}" class="form-control" step="0.01" min="0" max="{{ $buy->due_amount }}" required>
                    </div>
                    <div class="col-md-3">
